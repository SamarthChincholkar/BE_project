...
int batOy = 220;
int antiFlicker = 1;
TwoWire I2Cone = TwoWire(0); // Create a new I2C bus
...
//  Serial.println("Initializing MAX30102 with custom I2C pins...");
//
//  // Initialize I2C communication on custom pins
  I2Cone.begin(13, 15); // Initialize the second I2C bus on pins 13 (SDA) and 15 (SCL)
//
if (!particleSensor.begin(I2Cone, I2C_SPEED_FAST)) { // Use the Wire object for I2C
...
tft.setTextSize(2);
  ...
  if (OldirValue != irValue){
  drawJpeg("/swHourSquare.jpg", 0 , 50);drawJpeg("/swHourSquare.jpg", 20 , 50);
  }

  if (OldbeatsPerMinute != beatsPerMinute){
  drawJpeg("/swMinuteSquare.jpg", 0 , 100);drawJpeg("/swMinuteSquare.jpg", 25 , 100);
  }

  if (OldbeatAvg != beatAvg){
  drawJpeg("/swSecondSquare.jpg", 0 , 150);drawJpeg("/swSecondSquare.jpg", 20 , 150);
  }
